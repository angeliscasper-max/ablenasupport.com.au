...
import type { ShiftListing } from '../data/mock';

export function ShiftCard({ shift, onPress }: { shift: ShiftListing; onPress: () => void }) {
  return (
    <Card elevated>
      <View style={styles.topRow}>
        <Text style={type.cardKicker}>
          {shift.category.toUpperCase()} · {shift.distanceKm}KM
        </Text>
      ...
      <Text style={type.cardMeta}>
        {shift.day} · {shift.time} · {shift.rate}
      </Text>
